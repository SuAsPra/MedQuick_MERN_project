                ...
                <Grid container gap={1} justifyContent={'center'} alignContent={'center'}>
                  {
                    wishlistItems.map((item,index)=>(
                      <Stack component={is480?"":Paper} elevation={1} >
                          ...
                          <ProductCard key={item._id} id={item.product._id} title={item.product.title} thumbnail={item.product.thumbnail} brand={item.product.brand.name} price={item.product.price} handleAddRemoveFromWishlist={handleAddRemoveFromWishlist} requiresPrescription={item.product.requiresPrescription} isWishlistCard={true}/>
