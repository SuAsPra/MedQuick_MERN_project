    ...
    <Stack p={'0 16px'} justifyContent={'center'} alignItems={'center'} flexDirection={'row'} >
        ...
        <Stack width={is1100?"100%":"60rem"} rowGap={4} mt={is480?4:6} mb={6} component={'form'} noValidate onSubmit={handleSubmit(handleProductUpdate)}> 
            ...
            <Stack rowGap={3}>
                ...
                <Stack>
                    <Typography variant='h6'  fontWeight={400} gutterBottom>Requires Prescription</Typography>
                    <FormControl fullWidth>
                        <Select defaultValue={selectedProduct.requiresPrescription || false} {...register("requiresPrescription",{required:"Required"})}>
                ...
                <Stack>
                    <Typography variant='h6'  fontWeight={400} gutterBottom>Manufacturer</Typography>
                    <TextField {...register("manufacturer",{value:selectedProduct.manufacturer})}/>
                </Stack>
                <Stack flexDirection={'row'} columnGap={2}>
                    <Stack flex={1}>
                        <Typography variant='h6' fontWeight={400} gutterBottom>Dosage</Typography>
                        <TextField {...register("dosage",{value:selectedProduct.dosage})} placeholder="e.g. 500mg"/>
                    </Stack>
                    <Stack flex={1}>
                        <Typography variant='h6' fontWeight={400} gutterBottom>Medicine Type</Typography>
                        <TextField {...register("medicineType",{value:selectedProduct.medicineType})} placeholder="e.g. Tablet, Syrup"/>
                    </Stack>
                </Stack>
                <Stack>
                    <Typography variant='h6'  fontWeight={400} gutterBottom>Expiry Date</Typography>
                    <TextField type="date" InputLabelProps={{ shrink: true }} {...register("expiryDate",{value:selectedProduct.expiryDate ? new Date(selectedProduct.expiryDate).toISOString().split('T')[0] : ''})}/>
                </Stack>
