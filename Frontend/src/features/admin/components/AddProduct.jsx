        ...
        <Stack width={is1100?"100%":"60rem"} rowGap={4} mt={is480?4:6} mb={6} component={'form'} noValidate onSubmit={handleSubmit(handleAddProduct)}> 
            ...
            <Stack rowGap={3}>
                ...
                <Stack>
                    ...
                    <FormControl fullWidth>
                        <Select {...register("requiresPrescription",{required:"Required"})}>
                ...
                <Stack flexDirection={'row'} columnGap={2}>
                    <Stack flex={1}>
                        ...
                        <TextField {...register("dosage")} placeholder="e.g. 500mg"/>
                    </Stack>
                    <Stack flex={1}>
                        <Typography variant='h6' fontWeight={400} gutterBottom>Medicine Type</Typography>
                        <TextField {...register("medicineType")} placeholder="e.g. Tablet, Syrup"/>
                    </Stack>
                </Stack>
                <Stack>
                    <Typography variant='h6'  fontWeight={400} gutterBottom>Expiry Date</Typography>
                    <TextField type="date" InputLabelProps={{ shrink: true }} {...register("expiryDate")}/>
                </Stack>
